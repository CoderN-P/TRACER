...
class VirtualObstacle(BaseModel):
    ...
    rotation: float = Field(..., description="Rotation of the virtual obstacle in radians")
    width: float = Field(..., description="Width of the rectangular obstacle in meters")
    height: float = Field(..., description="Height of the rectangular obstacle in meters")
    radius: float = Field(..., description="Radius of the circular obstacle in meters")
