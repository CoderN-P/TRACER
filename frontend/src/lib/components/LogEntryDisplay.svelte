...
<div
  class="flex flex-row items-center w-full rounded-md py-1.5 px-2 hover:{getLogBackground()} border-l-2 border-transparent hover:border-l-2 hover:border-l-{getLogColor().replace(
    'text-',
    '',
  )} transition-colors"
>
