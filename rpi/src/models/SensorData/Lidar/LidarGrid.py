...
class LidarGrid(BaseModel):
    ...
    values: list[list[list[float]]] = Field(..., description="2D list of xy distance measurements in meters, where values[row][col] corresponds to the [x, y] distance at that grid cell")