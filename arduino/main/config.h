...
const float WHEEL_DIAMETER = 0.0541; // wheel diameter in meters
...
const float LEFT_CORRECTION_NEG = 0.995f;
...
static const CalibrationPoint_t calibration_forward_left[LOOKUP_TABLE_SIZE] = {
    {0.0231f, 0.10f}, {0.0333f, 0.12f}, {0.0444f, 0.14f}, {0.0550f, 0.16f},
    {0.0662f, 0.18f}, {0.0659f, 0.20f}, {0.0758f, 0.22f}, {0.0863f, 0.24f},
    {0.0965f, 0.26f}, {0.1062f, 0.28f}, {0.1260f, 0.30f}, {0.1354f, 0.32f},
    {0.1448f, 0.34f}, {0.1546f, 0.36f}, {0.1641f, 0.38f}, {0.1743f, 0.40f},
    {0.1842f, 0.42f}, {0.1942f, 0.44f}, {0.2032f, 0.46f}, {0.2125f, 0.48f},
    {0.2211f, 0.50f}, {0.2309f, 0.52f}, {0.2413f, 0.54f}, {0.2523f, 0.56f},
    {0.2619f, 0.58f}, {0.2720f, 0.60f}, {0.2811f, 0.62f}, {0.2912f, 0.64f},
    {0.3001f, 0.66f}, {0.3092f, 0.68f}, {0.3193f, 0.70f}, {0.3314f, 0.72f},
    {0.3387f, 0.74f}, {0.3473f, 0.76f}, {0.3569f, 0.78f}, {0.3650f, 0.80f},
    {0.3750f, 0.82f}, {0.3848f, 0.84f}, {0.3962f, 0.86f}, {0.4070f, 0.88f},
    {0.4149f, 0.90f}, {0.4267f, 0.92f}, {0.4353f, 0.94f}, {0.4419f, 0.96f},
    {0.4527f, 0.98f}, {0.4624f, 1.00f}
};

// Forward Right Calibration Lookup Table
static const CalibrationPoint_t calibration_forward_right[LOOKUP_TABLE_SIZE] = {
    {0.0222f, 0.10f}, {0.0318f, 0.12f}, {0.0426f, 0.14f}, {0.0529f, 0.16f},
    {0.0633f, 0.18f}, {0.0632f, 0.20f}, {0.0738f, 0.22f}, {0.0839f, 0.24f},
    {0.0941f, 0.26f}, {0.1041f, 0.28f}, {0.1240f, 0.30f}, {0.1340f, 0.32f},
    {0.1441f, 0.34f}, {0.1539f, 0.36f}, {0.1644f, 0.38f}, {0.1743f, 0.40f},
    {0.1843f, 0.42f}, {0.1954f, 0.44f}, {0.2045f, 0.46f}, {0.2146f, 0.48f},
    {0.2233f, 0.50f}, {0.2328f, 0.52f}, {0.2433f, 0.54f}, {0.2538f, 0.56f},
    {0.2634f, 0.58f}, {0.2730f, 0.60f}, {0.2821f, 0.62f}, {0.2916f, 0.64f},
    {0.2995f, 0.66f}, {0.3080f, 0.68f}, {0.3193f, 0.70f}, {0.3309f, 0.72f},
    {0.3399f, 0.74f}, {0.3483f, 0.76f}, {0.3575f, 0.78f}, {0.3622f, 0.80f},
    {0.3648f, 0.82f}, {0.3685f, 0.84f}, {0.3708f, 0.86f}, {0.3792f, 0.88f},
    {0.4015f, 0.90f}, {0.4198f, 0.92f}, {0.4285f, 0.94f}, {0.4428f, 0.96f},
    {0.4548f, 0.98f}, {0.4616f, 1.00f}
};

// Backward Left Calibration Lookup Table
static const CalibrationPoint_t calibration_backward_left[LOOKUP_TABLE_SIZE] = {
    {-0.4526f, -1.00f}, {-0.4432f, -0.98f}, {-0.4390f, -0.96f}, {-0.4358f, -0.94f},
    {-0.4212f, -0.92f}, {-0.4002f, -0.90f}, {-0.3889f, -0.88f}, {-0.3708f, -0.86f},
    {-0.3605f, -0.84f}, {-0.3538f, -0.82f}, {-0.3500f, -0.80f}, {-0.3472f, -0.78f},
    {-0.3425f, -0.76f}, {-0.3382f, -0.74f}, {-0.3338f, -0.72f}, {-0.3251f, -0.70f},
    {-0.3158f, -0.68f}, {-0.3005f, -0.66f}, {-0.2864f, -0.64f}, {-0.2792f, -0.62f},
    {-0.2756f, -0.60f}, {-0.2665f, -0.58f}, {-0.2571f, -0.56f}, {-0.2480f, -0.54f},
    {-0.2356f, -0.52f}, {-0.2287f, -0.50f}, {-0.2165f, -0.48f}, {-0.2062f, -0.46f},
    {-0.1961f, -0.44f}, {-0.1874f, -0.42f}, {-0.1775f, -0.40f}, {-0.1678f, -0.38f},
    {-0.1582f, -0.36f}, {-0.1474f, -0.34f}, {-0.1378f, -0.32f}, {-0.1279f, -0.30f},
    {-0.1075f, -0.28f}, {-0.0980f, -0.26f}, {-0.0877f, -0.24f}, {-0.0779f, -0.22f},
    {-0.0685f, -0.20f}, {-0.0685f, -0.18f}, {-0.0598f, -0.16f}, {-0.0496f, -0.14f},
    {-0.0385f, -0.12f}, {-0.0268f, -0.10f}
};

// Backward Right Calibration Lookup Table
static const CalibrationPoint_t calibration_backward_right[LOOKUP_TABLE_SIZE] = {
    {-0.4971f, -0.98f}, {-0.4887f, -0.96f}, {-0.4779f, -0.94f}, {-0.4690f, -0.92f},
    {-0.4592f, -0.90f}, {-0.4442f, -0.88f}, {-0.4314f, -0.86f}, {-0.4201f, -0.84f},
    {-0.4111f, -0.82f}, {-0.3992f, -0.80f}, {-0.3907f, -0.78f}, {-0.3850f, -0.76f},
    {-0.3749f, -0.74f}, {-0.3628f, -0.72f}, {-0.3508f, -0.70f}, {-0.3397f, -0.68f},
    {-0.3277f, -0.66f}, {-0.3175f, -0.64f}, {-0.3082f, -0.62f}, {-0.2990f, -0.60f},
    {-0.2874f, -0.58f}, {-0.2769f, -0.56f}, {-0.2675f, -0.54f}, {-0.2564f, -0.52f},
    {-0.2462f, -0.50f}, {-0.2323f, -0.48f}, {-0.2211f, -0.46f}, {-0.2102f, -0.44f},
    {-0.2006f, -0.42f}, {-0.1904f, -0.40f}, {-0.1800f, -0.38f}, {-0.1692f, -0.36f},
    {-0.1578f, -0.34f}, {-0.1471f, -0.32f}, {-0.1362f, -0.30f}, {-0.1148f, -0.28f},
    {-0.1044f, -0.26f}, {-0.0933f, -0.24f}, {-0.0829f, -0.22f}, {-0.0726f, -0.20f},
    {-0.0727f, -0.18f}, {-0.0609f, -0.16f}, {-0.0502f, -0.14f}, {-0.0389f, -0.12f},
    {-0.0270f, -0.10f}, {-0.0115f, -0.08f}
};
