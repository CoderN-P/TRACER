...
from src import Robot, SerialManager, run_socket_server, socketio, ROBOT_CONFIG, calibrate_wheelbase, serial_test, calibrate_feedforward, calibrate_max_speed, interactive_test, calibrate_mag
...
if __name__ == "__main__":
    ...
    if args.calibrate_wheel:
        ...
        calibrate_feedforward(args.resolution, args.duration, args.port)
