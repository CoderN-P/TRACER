...
<Card.Root class="w-full h-full min-h-0 pb-0 {className} flex flex-col">
  ...
  <Card.Content class="min-h-0 flex-1 overflow-y-auto overflow-x-hidden">
    {#if recordings.length === 0}
  ...
  <!-- Recording controls -->
  <div class="shrink-0 p-4 border-gray-300 bg-gray-50 rounded-b-xl">
    <div class="flex items-center justify-between">
